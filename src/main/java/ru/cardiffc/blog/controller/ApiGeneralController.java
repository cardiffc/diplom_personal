package ru.cardiffc.blog.controller;

import org.springframework.context.support.ClassPathXmlApplicationContext;
import ru.cardiffc.blog.main.Blog;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.stereotype.Controller;
import org.springframework.web.bind.annotation.GetMapping;
import ru.cardiffc.blog.TestBean;
import ru.cardiffc.blog.repositories.PostRepository;
...
public class ApiGeneralController {
    ...
    public ResponseEntity getTestBlog() {
        ...
        Blog blog = context.getBean("blog", ru.cardiffc.blog.main.Blog.class);
